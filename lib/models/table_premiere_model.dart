...
TablePremiereModel tablePremiereModelFromJson(String str) =>
    TablePremiereModel.fromJson(json.decode(str));

String tablePremiereModelToJson(TablePremiereModel data) =>
...
class TablePremiereModel {
  ...
  factory TablePremiereModel.fromJson(Map<String, dynamic> json) =>
      TablePremiereModel(
