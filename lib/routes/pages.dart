...
import 'package:tes_flutter/bindings/table_premiere_biniding.dart';
...
import 'package:tes_flutter/pages/login_google.dart';
...
import 'package:tes_flutter/pages/table_premiere_page.dart';
import 'routes.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(name: AppRoutes.loginGoogle, page: ()=> LoginGoogle()),
